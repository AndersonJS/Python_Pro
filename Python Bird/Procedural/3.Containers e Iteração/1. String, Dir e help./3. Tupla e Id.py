...
tpl1 = (5,)  # Tupla com um unico número.tem de colocar virgula no final pois se não colocar o python acha que é um int
print(tpl1)
print(type(tpl1))
...
print(id('_'))  # Quando perguntado id do último valor impresso com '_' dentro do id ele retorna o id da soma das tuplas
